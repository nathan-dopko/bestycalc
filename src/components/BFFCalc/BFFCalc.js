...
const pricingData = [
  { from: 1, to: 10, cost: "$20", price: 20 },
  { from: 11, to: 50, cost: "$15", price: 15 },
  // { from: 21, to: 50, cost: "$12", price: 12 },
  { from: 51, to: 100, cost: "$10", price: 10 },
  { from: 101, to: 250, cost: "$9", price: 9 },
  { from: 251, to: 499, cost: "$7", price: 7 },
  { from: 500, to: Infinity, cost: "$5", price: 5 },
];
