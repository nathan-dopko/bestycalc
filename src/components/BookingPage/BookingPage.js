    ...
    >
      {showThanks && (
        <>
          ...
          <p style={{ fontSize: "16px", color: "#555", marginBottom: "10px" }}>We're excited to announce Besty V2! Sign up for a demo below to see what's new:</p>
        </>
      )}
      <div className={styles.wrapper} style={{ padding: "20px", textAlign: "center", minHeight: "auto", position: "relative" }}>
        <div className={styles.bookingPage}>
          ...
          <form className={styles.bookingForm} onSubmit={handleSubmit}>
            <input type="number" id="listings" value={listings} onChange={handleChange} placeholder="Number of listings" min="1" required />
